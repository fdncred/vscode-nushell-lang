...
function activate(context) {
    ...
    const autoenvSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("autoenv ")) {
                const autoenvTrust = new vscode.CompletionItem("trust", vscode.CompletionItemKind.Method);
                autoenvTrust.detail =
                    "Trust a .nu-env file in the current or given directory";
                const autoenvUntrust = new vscode.CompletionItem("untrust", vscode.CompletionItemKind.Method);
    ...
    const chartSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("chart ")) {
                const chartBar = new vscode.CompletionItem("bar", vscode.CompletionItemKind.Method);
                chartBar.detail = "Bar charts";
                const chartLine = new vscode.CompletionItem("line", vscode.CompletionItemKind.Method);
    ...
    const configSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("config ")) {
                const configClear = new vscode.CompletionItem("clear", vscode.CompletionItemKind.Method);
                configClear.detail = "clear the config";
                const configGet = new vscode.CompletionItem("get", vscode.CompletionItemKind.Method);
                configGet.detail = "Gets a value from the config";
                const configPath = new vscode.CompletionItem("path", vscode.CompletionItemKind.Method);
                configPath.detail = "return the path to the config file";
                const configRemove = new vscode.CompletionItem("remove", vscode.CompletionItemKind.Method);
                configRemove.detail = "Removes a value from the config";
                const configSet = new vscode.CompletionItem("set", vscode.CompletionItemKind.Method);
                configSet.detail = "Sets a value in the config";
                const configSetInto = new vscode.CompletionItem("set_into", vscode.CompletionItemKind.Method);
    ...
    const dateSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("date ")) {
                const dateFormat = new vscode.CompletionItem("format", vscode.CompletionItemKind.Method);
                dateFormat.detail =
                    "Format a given date using the given format string.";
                const dateListTimezone = new vscode.CompletionItem("list-timezone", vscode.CompletionItemKind.Method);
                dateListTimezone.detail = "List supported time zones.";
                const dateNow = new vscode.CompletionItem("now", vscode.CompletionItemKind.Method);
                dateNow.detail = "Get the current date.";
                const dateToTable = new vscode.CompletionItem("to-table", vscode.CompletionItemKind.Method);
                dateToTable.detail = "Print the date in a structured table.";
                const dateToTimezone = new vscode.CompletionItem("to-timezone", vscode.CompletionItemKind.Method);
    ...
    const dropSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("drop ")) {
                const dropColumn = new vscode.CompletionItem("column", vscode.CompletionItemKind.Method);
                dropColumn.detail =
    ...
    const eachSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("each ")) {
                const eachGroup = new vscode.CompletionItem("group", vscode.CompletionItemKind.Method);
                eachGroup.detail =
                    "Runs a block on groups of `group_size` rows of a table at a time.";
                const eachWindow = new vscode.CompletionItem("window", vscode.CompletionItemKind.Method);
                eachWindow.detail =
    ...
    const formatSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("format ")) {
                const formatFilesize = new vscode.CompletionItem("filesize", vscode.CompletionItemKind.Method);
    ...
    const fromSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("from ")) {
                const fromBson = new vscode.CompletionItem("bson", vscode.CompletionItemKind.Method);
                fromBson.detail = "Convert from .bson binary into table";
                const fromCsv = new vscode.CompletionItem("csv", vscode.CompletionItemKind.Method);
                fromCsv.detail = "Parse text as .csv and create table.";
                const fromEml = new vscode.CompletionItem("eml", vscode.CompletionItemKind.Method);
                fromEml.detail = "Parse text as .eml and create table.";
                const fromIcs = new vscode.CompletionItem("ics", vscode.CompletionItemKind.Method);
                fromIcs.detail = "Parse text as .ics and create table.";
                const fromIni = new vscode.CompletionItem("ini", vscode.CompletionItemKind.Method);
                fromIni.detail = "Parse text as .ini and create table";
                const fromJson = new vscode.CompletionItem("json", vscode.CompletionItemKind.Method);
                fromJson.detail = "Parse text as .json and create table.";
                const fromOds = new vscode.CompletionItem("ods", vscode.CompletionItemKind.Method);
                fromOds.detail =
                    "Parse OpenDocument Spreadsheet(.ods) data and create table.";
                const fromSqlite = new vscode.CompletionItem("sqlite", vscode.CompletionItemKind.Method);
                fromSqlite.detail = "Convert from sqlite binary into table";
                const fromSsv = new vscode.CompletionItem("ssv", vscode.CompletionItemKind.Method);
                fromSsv.detail =
                    "Parse text as space-separated values and create a table. The default minimum number of spaces counted as a separator is 2.";
                const fromToml = new vscode.CompletionItem("toml", vscode.CompletionItemKind.Method);
                fromToml.detail = "Parse text as .toml and create table.";
                const fromTsv = new vscode.CompletionItem("tsv", vscode.CompletionItemKind.Method);
                fromTsv.detail = "Parse text as .tsv and create table.";
                const fromUrl = new vscode.CompletionItem("url", vscode.CompletionItemKind.Method);
                ...
                const fromYml = new vscode.CompletionItem("yml", vscode.CompletionItemKind.Method);
    ...
    const groupBySubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("group-by ")) {
                const groupByDate = new vscode.CompletionItem("date", vscode.CompletionItemKind.Method);
    ...
    const hashSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("hash ")) {
                const hashBase64 = new vscode.CompletionItem("base64", vscode.CompletionItemKind.Method);
    ...
    const keepSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("keep ")) {
                const keepUntil = new vscode.CompletionItem("until", vscode.CompletionItemKind.Method);
                keepUntil.detail = "Keeps rows until the condition matches.";
                const keepWhile = new vscode.CompletionItem("while", vscode.CompletionItemKind.Method);
    ...
    const mathSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("math ")) {
                const mathAbs = new vscode.CompletionItem("abs", vscode.CompletionItemKind.Method);
                mathAbs.detail = "Returns absolute values of a list of numbers";
                const mathAvg = new vscode.CompletionItem("avg", vscode.CompletionItemKind.Method);
                mathAvg.detail = "Finds the average of a list of numbers or tables";
                const mathCeil = new vscode.CompletionItem("ceil", vscode.CompletionItemKind.Method);
                ...
                const mathMedian = new vscode.CompletionItem("median", vscode.CompletionItemKind.Method);
                mathMedian.detail = "Gets the median of a list of numbers";
                const mathMin = new vscode.CompletionItem("min", vscode.CompletionItemKind.Method);
                mathMin.detail =
                    "Finds the minimum within a list of numbers or tables";
                const mathMode = new vscode.CompletionItem("mode", vscode.CompletionItemKind.Method);
                mathMode.detail =
                    "Gets the most frequent element(s) from a list of numbers or tables";
                const mathProduct = new vscode.CompletionItem("product", vscode.CompletionItemKind.Method);
                mathProduct.detail =
    ...
    const pathSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
    ...
    const randomSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("random ")) {
                const randomBool = new vscode.CompletionItem("bool", vscode.CompletionItemKind.Method);
                randomBool.detail = "Generate a random boolean value";
                const randomChars = new vscode.CompletionItem("chars", vscode.CompletionItemKind.Method);
                randomChars.detail = "Generate random chars";
                const randomDecimal = new vscode.CompletionItem("decimal", vscode.CompletionItemKind.Method);
                randomDecimal.detail =
                    "Generate a random decimal within a range [min..max]";
                const randomDice = new vscode.CompletionItem("dice", vscode.CompletionItemKind.Method);
                randomDice.detail = "Generate a random dice roll";
                const randomInteger = new vscode.CompletionItem("integer", vscode.CompletionItemKind.Method);
                randomInteger.detail = "Generate a random integer [min..max]";
                const randomUuid = new vscode.CompletionItem("uuid", vscode.CompletionItemKind.Method);
    ...
    const rollSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("roll ")) {
                const rollColumn = new vscode.CompletionItem("column", vscode.CompletionItemKind.Method);
                rollColumn.detail = "Rolls the table columns";
                const rollUp = new vscode.CompletionItem("up", vscode.CompletionItemKind.Method);
    ...
    const rotateSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("rotate ")) {
                const rotateCounterClockwise = new vscode.CompletionItem("counter-clockwise", vscode.CompletionItemKind.Method);
    ...
    const seqSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("seq ")) {
                const seqDate = new vscode.CompletionItem("date", vscode.CompletionItemKind.Method);
    ...
    const skipSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("skip ")) {
                const skipUntil = new vscode.CompletionItem("until", vscode.CompletionItemKind.Method);
                skipUntil.detail = "Skips rows until the condition matches.";
                const skipWhile = new vscode.CompletionItem("while", vscode.CompletionItemKind.Method);
    ...
    const splitSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("split ")) {
                ...
                const splitRow = new vscode.CompletionItem("row", vscode.CompletionItemKind.Method);
                splitRow.detail =
    ...
    const strSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("str ")) {
                ...
                const strReverse = new vscode.CompletionItem("reverse", vscode.CompletionItemKind.Method);
                strReverse.detail =
                    "outputs the reversals of the strings in the pipeline";
                const strRpad = new vscode.CompletionItem("rpad", vscode.CompletionItemKind.Method);
                strRpad.detail = "pad a string with a character a certain length";
                const strRtrim = new vscode.CompletionItem("rtrim", vscode.CompletionItemKind.Method);
                strRtrim.detail =
                    "trims whitespace or character from the end of text";
                const strScreamingSnakeCase = new vscode.CompletionItem("screaming-snake-case", vscode.CompletionItemKind.Method);
    ...
    const toSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("to ")) {
                const toBson = new vscode.CompletionItem("bson", vscode.CompletionItemKind.Method);
                toBson.detail = "Convert table into .bson binary";
                const toCsv = new vscode.CompletionItem("csv", vscode.CompletionItemKind.Method);
                toCsv.detail = "Convert table into .csv text ";
                const toHtml = new vscode.CompletionItem("html", vscode.CompletionItemKind.Method);
                toHtml.detail = "Convert table into simple HTML";
                const toJson = new vscode.CompletionItem("json", vscode.CompletionItemKind.Method);
                toJson.detail = "Converts table data into JSON text.";
                const toMd = new vscode.CompletionItem("md", vscode.CompletionItemKind.Method);
                ...
                const toUrl = new vscode.CompletionItem("url", vscode.CompletionItemKind.Method);
                toUrl.detail = "Convert table into url-encoded text";
                const toXml = new vscode.CompletionItem("xml", vscode.CompletionItemKind.Method);
                toXml.detail = "Convert table into .xml text";
                const toYaml = new vscode.CompletionItem("yaml", vscode.CompletionItemKind.Method);
    ...
    const urlSubCommandsProvider = vscode.languages.registerCompletionItemProvider("nushell", {
        provideCompletionItems(document, position) {
            const linePrefix = document
                .lineAt(position)
                .text.substr(0, position.character);
            if (linePrefix.endsWith("url ")) {
                const urlHost = new vscode.CompletionItem("host", vscode.CompletionItemKind.Method);
                urlHost.detail = "gets the host of a url";
                const urlPath = new vscode.CompletionItem("path", vscode.CompletionItemKind.Method);
                urlPath.detail = "gets the path of a url";
                const urlQuery = new vscode.CompletionItem("query", vscode.CompletionItemKind.Method);
                urlQuery.detail = "gets the query of a url";
                const urlScheme = new vscode.CompletionItem("scheme", vscode.CompletionItemKind.Method);
